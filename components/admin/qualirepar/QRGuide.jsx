...
const STEPS = [
  {
    ...
    tip: '💡 Dans ReparFlow, la vérification d\'éligibilité est automatique dès que vous créez un ticket — sélectionnez la marque et le type d\'appareil dans le panneau "Bonus QualiRépar".',
  },
  {
    ...
    tip: '💡 ReparFlow génère automatiquement la facture PDF avec la mention "Bonus Réparation" et le bon montant déduit. Utilisez le bouton "Télécharger la facture PDF" sur la page du ticket.',
  },
  {
  ...
  },
  {
    ...
    tip: '💡 ReparFlow détecte automatiquement l\'éco-organisme selon la marque et affiche le lien direct vers la bonne plateforme dans le panneau QualiRépar du ticket.',
  },
]
      ...
      <div className="bg-amber-500/8 border border-amber-500/15 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-amber-400/80 leading-relaxed">
            ...
            ReparFlow automatise tout le processus.
          </p>
        </div>
      </div>
