...
export async function generateInvoicePdf({ invoice, lines, shop }) {
  return new Promise((resolve, reject) => {
    ...
    doc.font('Helvetica-Bold').fontSize(22).fillColor(AMBER).text('ReparFlow', L, 25)
    ...
    doc.font('Helvetica').fontSize(8).fillColor('#6B7280')
       .text('Généré par ReparFlow — repairflow-app.vercel.app', L, yFooter + 12, { align: 'center', width: doc.page.width - 100 })
